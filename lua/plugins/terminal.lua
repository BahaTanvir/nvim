return {
	-- Floaterm - Floating terminal plugin
	{
		...
		keys = {
			...
			{ "<F7>", function() vim.cmd("FloatermToggle") end, mode = { "n", "t", "i" }, desc = "Toggle floating terminal" },
			...
			{ "<F9>", function() vim.cmd("FloatermNext") end, mode = { "n", "t", "i" }, desc = "Next Floaterm terminal" },
			-- Kill current terminal
			{ "<leader>tk", "<cmd>FloatermKill<cr>", desc = "Kill current terminal" },

			-- Show all terminals
			-- Quick terminal commands
			{ "<leader>tg", "<cmd>FloatermNew lazygit<cr>", desc = "Open lazygit in terminal" },
			{ "<leader>th", "<cmd>FloatermNew htop<cr>", desc = "Open htop in terminal" },
	...
	-- ToggleTerm for floating terminal
	{
		...
		keys = {
			...
			{ "<F8>", function() vim.cmd("1ToggleTerm direction=float") end, mode = { "n", "t", "i" }, desc = "Toggle floating terminal (toggleterm)" },
			{ "<F10>", function() vim.cmd("2ToggleTerm direction=vertical") end, mode = { "n", "t", "i" }, desc = "Toggle vertical terminal (toggleterm)" },		},
		cmd = { "ToggleTerm" },
		opts = {
			size = function(term)
